...
CREATE TABLE `clientes` (
  ...
  `ci` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_cliente_ci_tenant` (`tenant_id`,`ci`),
  KEY `idx_clientes_tenant` (`tenant_id`),
...
CREATE TABLE `detalle_ventas` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_detalle_tenant` (`tenant_id`),
  KEY `idx_detalle_venta` (`venta_id`),
  KEY `fk_detalle_producto` (`producto_id`),
  CONSTRAINT `fk_detalle_producto` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`),
  CONSTRAINT `fk_detalle_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`),
...
CREATE TABLE `productos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_producto_por_tenant` (`tenant_id`,`nombre`),
...
CREATE TABLE `tenants` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_tenant_nombre` (`nombre_comercial`)
...
CREATE TABLE `ventas` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ventas_tenant` (`tenant_id`),
  KEY `idx_ventas_tenant_fecha` (`tenant_id`,`created_at`),
...
--
-- Dumping events for database 'saas_db'
--

--
-- Dumping routines for database 'saas_db'
--
...
-- Dump completed on 2026-07-23 21:37:22
